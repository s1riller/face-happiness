  ...
  <header class="p-3 bg-discord-blue gg-sans">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul v-if="this.token && this.token!=='null'"  class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <router-link to="/Products" class="nav-link px-2 text-white">Продукты</router-link>
          <li><a href="#" class="nav-link px-2 text-white">About</a></li>
        </ul>

        <form v-if="this.token && this.token!=='null'" class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" role="search">
